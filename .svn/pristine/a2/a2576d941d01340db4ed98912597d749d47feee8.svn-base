function emailFormCheck(password1,password2,tele,email,db,type) {
...
emailFormCheck.prototype={
    constructor:emailFormCheck,

    initElements:function () {
        this.passwordTell = document.getElementById('isEmailPasswordCorrect');
        this.emailTell = document.getElementById('isEmailUserExist');
        this.phoneTell = document.getElementById('isEmailMobileExist');
    },
    ...
    initEvents:function () {
        ...
        this.password2.onblur=function () {
            ...
            if (this.value==that.password1.value){
                ...
                that.passwordTell.innerHTML="密码不正确";
                return false;
            }
        };
